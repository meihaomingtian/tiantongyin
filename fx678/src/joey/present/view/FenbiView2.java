 ...
 * 
 */
public class FenbiView2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		vLayout = (LinearLayout) findViewById(R.id.fenbiListView2);
		vLayout.addView(new GameViewOK(this, dm.widthPixels, dm.heightPixels));
		...
		progressDialog = new ProgressDialog(FenbiView2.this);
	...
	protected void addDialog() {
		AlertDialog.Builder builder = new Builder(FenbiView2.this);
